...
So we have a historical Data of these bicycle sharing system. Based on this data we findout the pattern and build the model to forcast bicycle sharing demand.
